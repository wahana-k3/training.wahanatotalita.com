...
export function WhatsAppWidget({ pageTitle }: WhatsAppWidgetProps) {
  ...
  return (
    <div className="wa-widget" id="wa-widget">
      ...
      {isOpen && (
        <div className="wa-card" id="wa-card" role="dialog" aria-label="Konsultasi WhatsApp">
          <div className="wa-card-head">
            <strong style={{ color: 'var(--c-ink)' }}>Tim Konsultan SDM &amp; K3</strong>
            <span className="wa-online">● Online</span>
          </div>
          <p>
            Ceritakan kebutuhan pelatihan atau pengembangan tim Anda. Tim kami siap merespons cepat tanpa biaya konsultasi awal.
          </p>
          <a
