        ...
        <div style="padding: 24px; background-color: #ffffff;">
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <tr>
              ...
              <td style="padding: 8px 0; color: #0f172a;">${nama}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; font-weight: bold; color: #475569;">Perusahaan:</td>
              <td style="padding: 8px 0; color: #0f172a;">${perusahaan}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 8px 0; color: #0f172a;">${telepon}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; font-weight: bold; color: #475569;">Kebutuhan Utama:</td>
              <td style="padding: 8px 0; color: #0f172a; font-weight: 600;">${kebutuhan}</td>
            </tr>
            <tr>
          ...
          <div style="background-color: #f8fafc; border-left: 4px solid #0284c7; padding: 16px; border-radius: 4px; margin-top: 16px;">
            ...
            <p style="margin: 0; white-space: pre-wrap; color: #1e293b;">${pesan}</p>
          </div>
        </div>
